 ...
 */
export const addFavoriteController: RequestHandler = async (request, response) => {
 ...
 */
export const listFavoritesController: RequestHandler = async (request, response) => {
  const auth = getProfileAuthContext(request);
 ...
 */
export const removeFavoriteController: RequestHandler = async (request, response) => {
  const auth = getProfileAuthContext(request);
  const { moverId } = parseMoverIdParam(request.params);
